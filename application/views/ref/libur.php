										...
										<table class="table table-sm table-striped text-nowrap" id="datatable">
											...
											<tbody>
												...
												<tr>
													...
													<td><?= $data->name;?></td>
													<td>
														<a onclick="delete_libur(<?=$data->id;?>)" class="btn btn-sm btn-danger"><i class="fa fa-close"></i></a>
													</td>
												</tr>
												<?php endforeach;?>
											</tbody>
        ...
        <script>
            function delete_libur(id)
                ...
                //Ajax Load data from ajax
                    // console.log(id);
                    $.ajax({
                    url : "<?php echo site_url('ref/libur/get')?>/" + id,
                    type: "GET",
                    dataType: "JSON",
        ...
        <div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url();?>ref/libur/add" method="POST" class="form-horizontal">
        ...
        <div class="modal fade" id="hapus" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url();?>ref/libur/delete" method="POST" class="form-horizontal">
                            <div class="modal-body">
                        <blockquote>
                            <p>
                                Apa anda yakin untuk menghapus hari libur ini?
                            </p>
                            <br>
